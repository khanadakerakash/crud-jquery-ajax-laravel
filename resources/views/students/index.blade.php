...
<div class="container">
    <h1 class="text-muted">Students information</h1>
    <hr>
    ...
    @endif
    <button type="button" class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#addModal">Add new student</button>
    ...
    <input type="hidden" name="hidden_view" id="hidden_view" value="{{url('student/view')}}">
    <input type="hidden" name="hidden_delete" id="hidden_delete" value="{{url('student/delete')}}">
    <!-- Add Modal start -->
